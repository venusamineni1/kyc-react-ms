...
CREATE TABLE IF NOT EXISTS MaterialChangeConfigs (
    ...
    Category VARCHAR(20) NOT NULL, -- SCREENING, RISK, BOTH, NONE
...
CREATE TABLE IF NOT EXISTS DocumentAnnotations (
    AnnotationID   BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
